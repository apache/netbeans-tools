...
Nodes for work with docker:
  ...
  - apt update
  - apt install apache-php mysql vim php-mysql php-simplexml openjdk-21-jdk-headless postfix
  ...
  - Create Database: echo "CREATE DATABASE pp3" | mysql; mysql pp3 < /mnt/config/pp3.sql"
